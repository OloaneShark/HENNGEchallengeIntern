...
This challenge is intended for the backend position, DevSecOps, or global internship (full-stack) applicants.

This challenge consists of three missions. After successfully completing Mission 3, you will receive an email with a link to submit your CV and Cover Letter (CL). Once we receive them, our engineers will review your code and documents (CV & CL) together, and we will contact you via email with the screening result. If you haven't received your result within a month, please let us know!

Candidates applying for full-time positions are required to use the language associated with the role that they are applying to (applying for Python Engineer positions should solve the challenge in Python, applying for Go Engineer positions should solve the challenge in Go). Candidates for other positions (Global Internship Program, DevSecOps Engineer) have the flexibility to choose their preferred language.

Tips: Due to the competitiveness of our application process, we highly recommend applicants to explain their motivation clearly in their Cover Letter (CL).
...
Your solution will be tested against Go 1.25 (as of August 2025) or higher.
package main
...
Sample Request
POST /challenges/backend-recursion/004 HTTP/1.1
